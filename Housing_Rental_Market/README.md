...
This application gives an analysis of real estate data for San Fransisco, vizualizing San Francisco market that are viable investment opportunities for the user. 
...
Clone local Repo: git clone https://github.com/Alexisg324/Housing_Rental_Market.git
...
As a user, I want to access real estate data in San Fransisco to determine the best investment opportunities.
...
UCB-Coding-Bootcamp (2021-2022). Module 6. UC Berkeley Fintech Extension. https://courses.bootcampspot.com/
